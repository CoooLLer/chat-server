...
type ChatV1Client interface {
	Create(ctx context.Context, in *CreateChatIn, opts ...grpc.CallOption) (*CreateChatOut, error)
	Delete(ctx context.Context, in *DeleteChatIn, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *chatV1Client) Create(ctx context.Context, in *CreateChatIn, opts ...grpc.CallOption) (*CreateChatOut, error) {
...
func (c *chatV1Client) Delete(ctx context.Context, in *DeleteChatIn, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type ChatV1Server interface {
	Create(context.Context, *CreateChatIn) (*CreateChatOut, error)
	Delete(context.Context, *DeleteChatIn) (*emptypb.Empty, error)
...
func (UnimplementedChatV1Server) Create(context.Context, *CreateChatIn) (*CreateChatOut, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedChatV1Server) Delete(context.Context, *DeleteChatIn) (*emptypb.Empty, error) {
...
func _ChatV1_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatV1Server).Create(ctx, req.(*CreateChatIn))
	}
...
func _ChatV1_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatV1Server).Delete(ctx, req.(*DeleteChatIn))
	}
	return interceptor(ctx, in, info, handler)
}
